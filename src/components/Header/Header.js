...
import superStar from "../../img/user-superstar-2x.jpg";

const Header = () => {
    return (<>
            <svg style={{display: "none"}}>
                <symbol id="logo" viewBox="0 0 133.44 24.37">
                ...
                <symbol id="signOut" viewBox="0 0 24 20">
                    <g>
                        <path
                    ...
                    <div className="header__inner">
                        ...
                        <div>
                            <nav className="nav">
                                ...
                                <a className="nav__link" href="#">Relationships </a>
                                <a className="nav__link" href="#">Requirements </a>
                                <a className="nav__link" href="#">Users </a>
                                <a className="nav__link" href="#">Sign Up </a>
                            </nav>
                        </div>
                        <div className={"header__superstar"}>
                            <div className={"header__superstar--email"}>
                                <div className={"header__superstar--email-text"}>
                                    Superstar
                                </div>
                                <div className={"header__superstar--email-item"}>
                                    Superstar@gmail.com
                                </div>
                            </div>
                            <div className={"header__superstar--img"}>
                                <img className={"header__superstar--photo"} src={superStar} alt=""/>
                            </div>
                            <div className={"header__test"}>
                                <a href="#">
                                    <svg className={"header__signOut"}>
                                        <use xlinkHref="#signOut"></use>
                                    </svg>
                                </a>
                            </div>
                        </div>
